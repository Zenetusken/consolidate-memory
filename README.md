...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-0.4.26-a999f5?style=flat-square&labelColor=0f1c2e" alt="Version 0.4.26"></a>
...
> [!NOTE]
> **Current release: v0.4.26** — the cross-domain mirror index refresh: one root cause on
> the write/accounting dependency, corrected in both directions, plus the `--gc` dead-probe.
