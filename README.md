...
**v0.4.6** (v0.4.0's sole-authority topology and SQLite grants; consolidated
...
production/polish/performance pass; the v0.4.5 issue-closeout; the v0.4.6 archive-display). This ships as a
