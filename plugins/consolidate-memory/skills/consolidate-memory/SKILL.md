...
settled. Until it is settled: **read `MEMORY.md` and propose the clusters yourself** — name the
stems, the est tokens each would free, and *why they are one claim*. Proposing none is a legitimate
