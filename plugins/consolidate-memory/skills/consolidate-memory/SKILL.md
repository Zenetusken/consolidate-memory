...
**v0.4.4** — sole-authority topology (SQLite holders/grants/migration state; one
...
and the renderer coherence sweep, plus the v0.4.4 docs sync). Public 1.0 stays HOLD.
